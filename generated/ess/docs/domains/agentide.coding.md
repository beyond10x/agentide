...
contract digest 790eaaf3fa0f498409d08306cdc021ee65e187b3df617c1b46667847fd63117a
...
It may invoke [`ApplyDeployment`](#applydeployment), [`CancelProcess`](#cancelprocess), [`CreateWorktree`](#createworktree), [`CutRelease`](#cutrelease), [`DelegateAgent`](#delegateagent), [`EditCode`](#editcode), [`FinishWorktree`](#finishworktree), [`InputProcess`](#inputprocess), [`MessageAgent`](#messageagent), [`ObserveAgents`](#observeagents), [`ObserveChanges`](#observechanges), [`ObserveDeployment`](#observedeployment), [`ObserveProcess`](#observeprocess), [`ObserveWorktree`](#observeworktree), [`PublishCode`](#publishcode), [`ReadCode`](#readcode), [`RecordEvidence`](#recordevidence), [`SearchCode`](#searchcode), [`StartProcess`](#startprocess), [`VerifyCode`](#verifycode), [`WaitAgent`](#waitagent) and [`WaitProcess`](#waitprocess).


---

Generated from agentide v1 · model digest `58797505a3290f8148d59cef148f849bf91ea9836f1f9d89d5cc63dac190f3da` · contract digest `790eaaf3fa0f498409d08306cdc021ee65e187b3df617c1b46667847fd63117a`. Do not edit this file; change the specification and regenerate it with `ess generate`.
