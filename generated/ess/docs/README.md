...
- **[Workspace surface](domains/agentide.surface.md)** (`agentide.surface`) — A renderer-neutral virtual workbench shared by agents, the browser, CLI snapshots, and the console TUI. Three types, one entity, one view, eight commands, eight events, one error and one actor.
